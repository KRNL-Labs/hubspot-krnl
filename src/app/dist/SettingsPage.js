...
this.SettingsPage.js = (function(React2, react) {
  "use strict";
  ...
  hubspot.extend(({ context, actions, fetch: fetch2 }) => {
  ...
  const AccessShieldSettings = ({ context, actions, fetch: fetch2 }) => {
    ...
    const loadSettings = async () => {
      setLoading(true);
      try {
        const response = await fetch2("https://051892e58926.ngrok-free.app/api/settings", {
          method: "GET",
          headers: {
    ...
    const saveSettings = async () => {
      ...
      try {
        const response = await fetch2("https://051892e58926.ngrok-free.app/api/settings", {
          ...
          body: JSON.stringify({
            settings,
            portalId: (_a = context.portal) == null ? void 0 : _a.id
          })
        });
        if (response.ok) {
          setSuccess(true);
    ...
    if (loading) {
      return /* @__PURE__ */ React2.createElement(Flex, { justify: "center", align: "center", style: { minHeight: "200px" } }, /* @__PURE__ */ React2.createElement(LoadingSpinner, { size: "large" }));
    }
    return /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "large" }, /* @__PURE__ */ React2.createElement(Card, null, /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "medium" }, /* @__PURE__ */ React2.createElement(Heading, null, "AccessShield Settings"), /* @__PURE__ */ React2.createElement(Text, null, "Configure your AccessShield integration settings."), error && /* @__PURE__ */ React2.createElement(Alert, { variant: "error", title: "Error" }, error), success && /* @__PURE__ */ React2.createElement(Alert, { variant: "success", title: "Success" }, "Settings saved successfully!"), /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "small" }, /* @__PURE__ */ React2.createElement(Text, { weight: "bold" }, "Blockchain Network"), /* @__PURE__ */ React2.createElement(
      Select,
      {
    ...
    ), /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy" }, "Network used for blockchain registration (sepolia for testing, mainnet for production)")), /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "small" }, /* @__PURE__ */ React2.createElement(Text, { weight: "bold" }, "Auto Watermarking"), /* @__PURE__ */ React2.createElement(
      Select,
      {
    ...
    ), /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy" }, "Automatically apply identity-bound watermarks to documents")), /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "small" }, /* @__PURE__ */ React2.createElement(Text, { weight: "bold" }, "Document Retention (Days)"), /* @__PURE__ */ React2.createElement(
      Input,
      {
        type: "number",
    ...
    ), /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy" }, "Number of days to retain document access logs")), /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "small" }, /* @__PURE__ */ React2.createElement(Text, { weight: "bold" }, "Compliance Mode"), /* @__PURE__ */ React2.createElement(
      Select,
      {
    ...
    ), /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy" }, "Compliance level: standard, strict, or custom")), /* @__PURE__ */ React2.createElement(Flex, { justify: "end", gap: "medium" }, /* @__PURE__ */ React2.createElement(
      Button,
      {
        variant: "secondary",
